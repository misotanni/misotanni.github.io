  ...
  var loc = {
   ...
   wrongIntVariant: "L'intervalle « %1 » ne peut pas être dans la catégorie « %2 ».",
    ...
    butPythagorean: "2 et 3 sont des octaves et quintes pythagoriciennes qui n'ont pas besoin des altérations FJS.",
         ...
         setlambda: "Ajuster le rayon de tolérance à n'importe quelle valeur d'une décimale (nombre à virgule flottante) entre 1 et sqrt(2). <br>Écrivez « default » (de l'anglais « par défaut ») pour retourner à la valeur conventionnelle, 65/63."
  };
</script>
