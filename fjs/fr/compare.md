...
De l'autre côté, la notation de Ben Johnston était développée par un seul compositeur JI. [L'article le plus complet](https://www.jstor.org/stable/833435) sur ce sujet énumère des altérations jusqu'au 31-limite, ce qui est aussi indiqué dans un manuel par [Kyle Gann](https://kylegann.com/BJNotation.html).
...
Les contradictions de ces tons diatoniques causent une avalanche de problèmes chez Johnston. Donc ne soyez pas surpris ou surprise que je retourne souvent à ce problème fondamental.
...
- 2304/2303, un comma de 47 avec un facteur 7.
- 160/159, un comma de 53 avec un facteur 5.
- 768/767, un comma de 57 avec un facteur 13.
- 1281/1280, un comma de 61 avec un facteur 7.
...
Chez Helmholtz-Ellis ça marche aussi. Il y a seulement une différence: Helmholtz-Ellis a parfois besoin de deux altérations pour un nombre premier. Pourtant il est possible d'automatiser ce processus sans aucun problème. Il y a une [calculatrice en ligne](https://www.plainsound.org/HEJI/) pour ce but.
...
**Ben Johnston.** Trois minutes, mais j'ai déjà vu ce fragment de l'échelle harmonique chez Johnston.
