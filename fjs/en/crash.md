...
> 2. Divide the octave-reduced version of the prime interval by the Pythagorean approximation. This is the formal comma.
> 3. DO NOT take the reduced form. If you get a number less than 1, so be it.
>
> **Example:** We are given that the generator of 5 is +4. So we raise 3 to this power and take the reduced form: 3<sup>4</sup> = 81, reduced 81/64. Now we divide the reduced prime interval, 5/4, by 81/64. We obtain (5/4) ÷ (81/64) = 80/81. (We do not adjust this interval to the form 160/81.)
