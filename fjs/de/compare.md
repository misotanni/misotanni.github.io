...
Das FJS ist genau für JI entworfen worden, und während es optimal für JI ist, kann es überhaupt nichts anderes notieren. **Es gibt zwei andere solche Systeme mit ähnlichen Zielen:** das Helmholtz-Ellis-System und das Notationssystem von Ben Johnston. (Es gibt auch ein besonderes Notationssystem namens Sagittal, das für alle mikrotonale Musik geeignet ist. Ich werde es aber hier nicht berücksichtigen, denn bei Sagittal geht es nur um die Darstellung von Tonhöhe, deshalb wird es immer mehrdeutig bei JI sein, egal wie präzis seine Versetzungszeichen sind.)
